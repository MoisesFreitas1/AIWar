...
public class DTPlayerController : MonoBehaviour
{
    ...
    // Decision Trees
    private DecisionTreeControllers referee;
    private DecisionTree treeThrust, treeSteer;
    public int[] answerThrust;
    public int[] answerSteer;
    ...
    void Start()
    {
        ...
        referee = GameObject.FindGameObjectWithTag("DTController").GetComponent<DecisionTreeControllers>();
    ...
    void FixedUpdate()
    {
        ...
        if (referee.GetComponent<DecisionTreeControllers>().GetTimesRessurect() == 0)
        {
