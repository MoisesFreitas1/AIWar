...
public class LRPlayerController : MonoBehaviour
{
    ...
    // SVMs
    private LogisticRegressionController referee;
    private LogisticRegression treeThrust, treeSteer;
    ...
    void Start()
    {
        ...
        referee = GameObject.FindGameObjectWithTag("LRController").GetComponent<LogisticRegressionController>();
    ...
    void FixedUpdate()
    {
        ...
        if (referee.GetComponent<LogisticRegressionController>().GetTimesRessurect() == 0)
        {
